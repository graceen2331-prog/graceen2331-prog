...
我是一名拥有产品思维的 AI 开发者。专注于 **LLM 应用落地**、**Prompt Engineering** 以及**数据可视化**。
我不只写代码，我构建解决实际商业问题的 MVP。

---

### 🛠️ Featured Projects (AI & Tools)
...
#### 📚 **AI PDF Translator (PDF 智能沉浸式翻译)**
* **Problem**: 传统翻译工具（如谷歌翻译）常破坏 PDF 排版，且对专业术语缺乏上下文理解。
* **Solution**: 
  1. 解析：利用 PDF 解析库精准提取文本与坐标。
  2. 翻译：接入 LLM API 进行段落级上下文翻译，保持语义连贯。
...
#### 💼 **AI-Powered Resume Builder (个人简历网站)**
